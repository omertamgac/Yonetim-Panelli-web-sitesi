...
//SİTEYE GİRŞ YAPAN CİHAZA GÖRE AYARLAMALAR YAPAR
...
function loc(){
//mevcut sayfanın URL'sinin başına "http://localhost" ekleyerek, tam URL'yi içeren bir dizeyi döndürür.
    $loc =  "http://artek.epizy.com/".$_SERVER['REQUEST_URI'];
    return $loc;
}
