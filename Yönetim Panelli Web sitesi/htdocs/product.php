...
<div class="heading-banner-area overlay-bg" style="background: rgba(0, 0, 0, 0) url(<?php echo site;?>/uploads/<?php echo $catrow?>) no-repeat scroll center center / cover;">
<div class="container">
<div class="row">
<div class="col-md-12">
...
<div class="fix mb-20">
<span style="float: right;" class="pro-price"><b>Ürün Fiyat :</b> <?php echo $price." ₺";?> | <b>Ürün Kodu:</b> <?php echo $row->urunkodu;?></span>
</div>
...
<input type="hidden" value="<?php echo $row->urunkodu;?>" name="pcode"/>
	...
	<button style="color:white" type="submit" onclick="addcart();" id="addcartt" class="btn btn-default"><i class="zmdi zmdi-shopping-cart-plus"></i> Sepete Ekle</button>
...
<?php 
$pimageslider = $db->prepare("SELECT resimurun,resimdosya,resimdurum,kapak,resimtarih FROM urun_resimler WHERE resimurun=:u ORDER BY resimtarih ASC");
...
<li><a style="border-radius:15px;" class="active" href="#description" data-bs-toggle="tab">Ürün Açıklaması</a></li>
<li><a style="border-radius:15px;" href="#reviews"  data-bs-toggle="tab">Ürün Yorumları (<?php echo $comment->rowCount();?>)</a></li>
<li><a style="border-radius:15px;" href="#information" data-bs-toggle="tab">Ürün Özellikler</a></li>
</ul>
</div>
</div>
<div class="col-md-9">
...
<div class="pro-tab-info pro-information">
	<h3 style="float: left;" class="tab-title title-border mb-30"><?php echo $row->urunbaslik;?> Özellikleri</h3>
